...
`title`              varchar(100)  DEFAULT NULL					COMMENT 'My title in this position',
`responsibilities`   varchar(500)  DEFAULT NULL                 COMMENT 'My responsibilities in this position',
